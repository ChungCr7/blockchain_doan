  ...
  return (
    <nav className="bg-gray-900 text-white shadow px-6 py-4 flex justify-between items-center fixed top-0 left-0 w-full z-50">
      ...
      <ul className="flex gap-6 text-sm">
        ...
        <li><Link to="/list">🛠️ Rao bán NFT</Link></li>
        ...
        <li><Link to="/collection" className="hover:text-yellow-300">Bộ sưu tập</Link></li>
         <li>
    <Link to="/history" className="hover:text-yellow-300">📜 Lịch sử giao dịch</Link>
  </li>
      ...
      <div className="flex gap-3">
        <Link to="/login">
          <button className="bg-transparent border border-yellow-400 text-yellow-400 px-4 py-1 rounded hover:bg-yellow-400 hover:text-black">
            Đăng nhập
          </button>
        </Link>
        <Link to="/register">
